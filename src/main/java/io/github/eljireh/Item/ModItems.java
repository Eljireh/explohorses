...
public class ModItems {
    ...
    public static final RegistryObject<Item> HEALING_APPLE = ModCreativeModTab.addToTab(ITEMS.register("healing_apple",
            () -> new Item(new Item.Properties().food(ModFoodProperties.HEALING_APPLE))));
    ...
    public static final RegistryObject<Item> HENRY_HORSE_SPAWN_EGG = ModCreativeModTab.addToTab(ITEMS.register("henry_horse_spawn_egg",
            () -> new ForgeSpawnEggItem(ModEntities.HENRY_HORSE, 0xffffff, 0x000000, new Item.Properties())));
