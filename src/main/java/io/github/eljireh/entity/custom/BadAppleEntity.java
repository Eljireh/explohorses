...
public class BadAppleEntity extends Animal implements PowerableMob {
    public final AnimationState idleAnimationState = new AnimationState();
    private int idleAnimationTimeout = 0;
    private int explosionRadius = 3;

    public BadAppleEntity(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new TemptGoal(this, 1.15,
                stack -> stack.is(Items.APPLE), false));
    ...
    public @Nullable AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob pOtherParent) {
        return ModEntities.BAD_APPLE_HORSE.get().create(pLevel);
    }
