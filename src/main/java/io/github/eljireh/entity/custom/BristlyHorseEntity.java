...
public class BristlyHorseEntity extends ExplosiveHorseEntity {
    private int explosionRadius = 2; // Mis ici pour être plus facile à voir

    public BristlyHorseEntity(EntityType<? extends ExplosiveHorseEntity> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new BreedGoal(this, 1.0, BristlyHorseEntity.class));
    ...
    public @Nullable AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob pOtherParent) {
        return ModEntities.BRISTLY_HORSE.get().create(pLevel);
    }
