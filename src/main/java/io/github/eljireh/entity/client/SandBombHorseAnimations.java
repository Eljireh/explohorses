...
public class SandBombHorseAnimations {
        public static final AnimationDefinition horsey_walking = AnimationDefinition.Builder.withLength(2.0F).looping()
                ...
                .addAnimation("front_right_leg", new AnimationChannel(AnimationChannel.Targets.POSITION,
                        ...
                        new Keyframe(0.625F, KeyframeAnimations.posVec(0.0F, -2.0F, -4.0F), AnimationChannel.Interpolations.LINEAR),
                ...
                .addAnimation("back_right_leg", new AnimationChannel(AnimationChannel.Targets.POSITION,
                        ...
                        new Keyframe(1.3333F, KeyframeAnimations.posVec(0.0F, 5.0F, -3.0F), AnimationChannel.Interpolations.LINEAR),
                ...
                .addAnimation("front_left_leg", new AnimationChannel(AnimationChannel.Targets.POSITION,
                        ...
                        new Keyframe(1.5833F, KeyframeAnimations.posVec(0.0F, -2.0F, -4.0F), AnimationChannel.Interpolations.LINEAR),
                        new Keyframe(2.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
                ))
                ...
                .addAnimation("back_left_leg", new AnimationChannel(AnimationChannel.Targets.POSITION,
                        ...
                        new Keyframe(0.4167F, KeyframeAnimations.posVec(0.0F, 5.0F, -3.0F), AnimationChannel.Interpolations.LINEAR),
